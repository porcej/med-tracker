...
//         { data: 'bib' },
//         { data: 'ReportTime' },
//         { data: 'HospitalTransport' },
//         { 
//             data: 'hospital',
//             render: (data, type, row) =>
//                 type === 'display' ? '<input type="checkbox" class="editor-transport-hospital">' : data,
//                 className: 'dt-body-center'
//         },
//     ],
//     dom: 'Bfrtip',
...
//         row.querySelector('input.editor-transport-hospital').checked = data.HospitalTransport == 1;
//     }
// });
...
// table.on('change', 'input.editor-transport-hospital', function () {
//     editor
//         .edit(this.closest('tr'), false)
//         .set('HospitalTransport', this.checked ? 1 : 0)
//         .submit();
// });